void UnifiedScale(FullSol* InitialFullSolution, CommonList* CurCommonLists, float LinksDelay, int ServerCap, int InPathLinks, ofstream &myfile2, ChangeInfo CurrentChange, ChangedPolicies* TrackChangedPolicies){
