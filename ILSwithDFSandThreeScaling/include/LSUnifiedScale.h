void LSUnifiedScale(FullSol* InitialFullSolution, CommonList* CurCommonLists, float LinksDelay, int ServerCap, int InPathLinks, ofstream &myfile2, ChangedPolicies* TrackChangedPolicies ){
